...
SECRET_KEY = 'django-insecure-!yfcd)r_g1+xdafg%c&9&z7g*cx^($l)pb+7bb6c0=)u6-j-!v'
...
AUTH_TOKEN = 'ENTER YOUR TWILIO ACCOUNT AUTH_TOKEN'
TWILIO_NUM = 'ENTER YOUR TWILIO NUMBER'
